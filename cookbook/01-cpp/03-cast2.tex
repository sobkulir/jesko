...
a opakujúci sa kód je dlhý len tri riadky. Aj tak, keď si zmyslíme, že nechceme vypisovať 10 čísel
ale 11, tak to treba všade prepísať. Fuj.

Teraz si predstavme, že robíme niečo podstatne zložitejšie a 
na 200 miestach by sme mali rovnaký 10 riadkový blok. Keby sme tam chceli niečo zmeniť, tak sa zbláznime.
A určite pri nejakom prepise spravíme chybu. A nemáme šancu tú chybu nájsť.

Proste copy-pastovanie kódu je zlo a chceme sa mu vyhnúť, 
lebo tvorí neprehľadné a chybné programy. Ale ako sa mu vyhneme?

\medskip

Celkom dobrý spôsob je zabaliť kus kódu do funkcie -- nejako si ten kus kódu nazvať.
...
Funkcia môže vracať nejakú hodnotu a \textit{ten} typ je typ hodnoty, akú funkcia vracia.
Void znamená, že funkcia nevracia nič. Funkcia, ktorá niečo vracia, môže byť 
napríklad funkcia \verb!osem()! z nasledujúceho príkladu. Isto si všimnete, že
na vrátenie hodnoty slúži príkaz \verb!return!. Príkaz \verb!return! zároveň skončí
vykonávanie funkcie, preto všetko, čo je za ním, sa už nevykoná. 
...
Tak si vysvetlíme dve veci zároveň. Argumenty sú akoby vstup pre funkciu.
