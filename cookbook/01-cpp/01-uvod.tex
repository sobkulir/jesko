...
Kompilácia vo Windows závisí od prostredia, ktoré používate.
Väčšinou stačí stlačit nejakú klávesovú skratku a program sa skompiluje.
...
Vyriešte prvé štyri úlohy v prvej sade: \textbf{cpp01(Ahoj JeŠko)}, \textbf{cpp02(Číslo)}, 
\textbf{cpp03(Zámena)}, \textbf{cpp04(Obdĺžnik)}.
