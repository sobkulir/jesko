...
\cvicenie{1} skompilujte si vyššie uvedený program. A spustite ho. Čo sa stalo?
...
\cvicenie{3} skúste na obrazovku vypísať reťazec \verb!"jesko"! aj s
úvodzovkami.

\riesenie{1} Program vypíše reťazec \verb"jesko". Keď vynecháme znak \verb!'\'!
...
\riesenie{2} Niektoré prebytočné medzery a prázdny riadok. Z nasledovného
...
\cvicenie{1} Skúste určiť, čo robí nasledovný program. Aké hodnoty budu na
...
\cvicenie{2} Skúste na rôznych miestach programu z cvičenia 1 vypísať hodnoty
...
\cvicenie{3} Vyskúšajte si spustiť príkaz \verb!printf("%d\n", 2147483647 + 1);!.
...
\cvicenie{4} Preveďte z desiatkovej sústavy nasledovné čísla $31$, $200$,
$1024$.

\cvicenie{5} Preveďte z dvojkovej sústavy do desiatkovej čísla $10101$,
$100000000$, $1100110011$.

\cvicenie{6} Sčítajte v binárnej sústave čísla $110110$ a $1111101$. Následne
...
\riesenie{4} $31_{10} = 11111_2$. $200_{10} = 11001000$. $1024_{10} =
10000000000$, lebo $1024 = 2^{10}$.

\riesenie{5} $10101_2 = 21_{10}$. $100000000_2 = 256$. $1100110011_2 =
819_{10}$

\riesenie{6} V binárnej sústave sčítavme rovnako ako v desiatkovej, napíšeme si
...
\cvicenie{7} Skopírujte, skompilujte a spustite nasledovný program.  (Pokiaľ
...
\riesenie{7} Vynásobili sme dva \verb!int!y, keďže majú rovnaký typ, nič sa
...
\cvicenie{8} Aké budu hodnoty v $a$, $b$ po nasledovných priradeniach? 
\begin{lstlisting}
int a = 1234, b;
b = (char)a;
b = char(a);
...
\riesenie{8} Hodnota $a$ bude vždy 1234, pretypovanie nemení premenné. 
$b$ bude mať hodnoty -46, -46 a -56764 (teda $-46\cdot 1234$).

\medskip

\textbf{Poznámka}, \verb!bool! nie je číselný typ. Teda \verb!bool(int(4))! nie
...
\cvicenie{1} Vezmite nejaký program, kde ste viackrát použili \verb!printf! a
